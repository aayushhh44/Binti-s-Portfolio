  ...
  return (
    ...
    <div className='p-8'>
      ...
      <p className='font-poppins text-footertext mb-2'>Menu</p>
        ...
        <p className='font-poppins text-white cursor-pointer hover:underline hover:uppercase'>Show reels</p>
        <p className='font-poppins text-white cursor-pointer hover:underline hover:uppercase'>Profile</p>
      ...
      <div className='flex flex-col gap-4 w-full sm:w-1/3'>
        ...
        <div className='my-2'>
            ...
            <p className='font-p text-white'>Milan Chowk Kathmandu, Nepal</p>
...
<div className='flex justify-between p-8 items-center'>
  <p className='text-footertext font-poppins'>Bint btm ©</p>
  <p className='text-footertext font-poppins'>Designed by: <a target='_blank' href="https://www.linkedin.com/in/aayush-poudel-915007223/">Aayush Poudel</a></p>


<div onClick={ScrollUp} className='flex items-center cursor-pointer transform translate duration-150 hover:scale-125'>
  <button className='text-footertext font-poppins'>Back to Top </button>
