...
const Contact = () => {
  ...
  return (
    <div className='p-8 contact-container'>
      ...
      <div className='flex flex-col sm:flex-row'>
        <div className='sm:w-1/3 w-full'>
          <div className='flex flex-col items-center gap-10 justify-center border border-black h-[500px] sm:h-[600px]'>
            <div className='flex gap-2 items-center transform transition-transform duration-300 hover:scale-110 cursor-pointer contact-item'>
              <CiMail size={19} />
              <p className='text-lg md:text-xl'>binitbt@gmail.com</p>
            </div>
            <div className='flex gap-2 items-center transform transition-transform duration-300 hover:scale-105 cursor-pointer contact-item'>
              <CiPhone size={19} />
              <p className='text-lg md:text-xl'>+977 9843249388</p>
            </div>
            <div className='flex gap-2 items-center transform transition-transform duration-300 hover:scale-105 cursor-pointer contact-item'>
              <CiInstagram size={19} />
              <Link className='text-lg md:text-xl' to="binitbt">bintibtm</Link>
            </div>
            <div className='flex gap-2 items-center transform transition-transform duration-300 hover:scale-105 cursor-pointer contact-item'>
              <CiFacebook size={19} />
              <Link className='text-lg md:text-xl' to="binitbt">bintibtm</Link>
        ...
        <div className='w-full sm:w-2/3 bg-red-400'>
          <div className='flex flex-col p-20'>
            <h2 className='font-poppins text-3xl'>I'd love to hear from you</h2>
            <p className='font-poppins'>Leave a message below, and I'll get back to you as soon as possible</p>
            <form className=' flex flex-col gap-4 mt-4'>
              ...
              <button type='submit' className='transform transition-transform duration-300 hover:scale-105 bg-red-500 w-32 mt-3 p-2 text-nowrap text-left form-item'>
                Send Message
              </button>   
            </form>
          </div>
